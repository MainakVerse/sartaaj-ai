    ...
    <div className="relative flex flex-col items-start gap-8">
      <Form {...form}>
        ...
        >
                    ...
                    <FormLabel className="flex items-center justify-between pb-2">
                      <span className="flex items-center justify-center">
                        ...
                        <Tooltip>
                          ...
                          >
                            <p>
                              This parameter is called Temperature. Setting a higher value produces more creative and
                              catchy bios, while a lower setting sticks to
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Textarea
                        {...field}
                        placeholder="Add your old social media bio or elevate your brand"
                        className="text-black min-h-[10rem]"
                      />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
          ...
          <Button className="bg-blue-300 text-black hover:text-white rounded" type="submit" disabled={loading}>
